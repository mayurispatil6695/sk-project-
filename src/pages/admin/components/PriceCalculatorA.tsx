 ...
 const [briefingForm, setBriefingForm] = useState<{
  ...
  const fetchTrainingSessions = async () => {
    try {
      ...
      setTrainingSessions([]); // Empty array on error
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchStaffBriefings = async () => {
    try {
      ...
      setStaffBriefings([]); // Empty array on error
    }
  };
  ...
  const handleAddTraining = async () => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || getErrorMessage(error) || 'Error adding training session');
    }
  };
  ...
  const handleAddBriefing = async () => {
    ...
    try {
      ...
      console.error('Full error:', error);
      const err = error as { response?: { data?: { message?: string } } };
      toast.error(err.response?.data?.message || getErrorMessage(error) || 'Error adding staff briefing');
    }
  };
  ...
  const deleteTraining = async (id: string) => {
    try {
      ...
      toast.error(getErrorMessage(error) || 'Error deleting training session');
    }
  };
  ...
  const deleteBriefing = async (id: string) => {
    try {
      ...
      toast.error(getErrorMessage(error) || 'Error deleting staff briefing');
    }
  };
  ...
  const updateTrainingStatus = async (id: string, status: TrainingSession['status']) => {
    try {
      ...
      toast.error(getErrorMessage(error) || 'Error updating training status');
    }
  };
  ...
  const updateActionItemStatus = async (
    ...
    try {
      ...
      toast.error(getErrorMessage(error) || 'Error updating action item status');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: 'safety' | 'technical' | 'soft_skills' | 'compliance' | 'other') => 
                          setTrainingForm(prev => ({ ...prev, type: value }))
                        }
                        disabled={loading}
                      >
                  ...
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: string) => setTrainingForm(prev => ({ ...prev, department: value }))}
                        disabled={loading}
                      >
                        <SelectTrigger className="h-9 md:h-10">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: 'morning' | 'evening' | 'night') => 
                          setBriefingForm(prev => ({ ...prev, shift: value }))
                        }
                        disabled={loading}
                      >
                        <SelectTrigger className="h-9 md:h-10">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: string) => setBriefingForm(prev => ({ ...prev, department: value }))}
                        disabled={loading}
                      >
                        <SelectTrigger className="h-9 md:h-10">
                          <SelectValue placeholder="Select department" />
                        ...
                        <div className="flex-1">
                          ...
                          <Select
                            ...
                            onValueChange={(value: 'low' | 'medium' | 'high') => 
                              updateActionItem(index, 'priority', value)
                            }
                            disabled={loading}
                          >
      ...
      {loading && viewMode === 'list' ? (
        ...
        <>
          {/* Tabs */}
          <Tabs defaultValue="training" className="mb-6" onValueChange={(value: string) => setActiveTab(value as 'training' | 'briefing')}>
                                  ...
                                  <div className="flex gap-2">
                                    <Select
                                      ...
                                      onValueChange={(value: 'scheduled' | 'ongoing' | 'completed' | 'cancelled') => 
                                        updateTrainingStatus(session._id, value)
                                      }
                                      disabled={loading}
                                    >
